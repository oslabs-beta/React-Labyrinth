...
class Parser {
    ...
    parser(componentTree) {
        ...
        let ast;
        try {
            ast = babel.parse(fs.readFileSync(path.resolve(componentTree.filePath), 'utf-8'), {
                sourceType: 'module',
                tokens: true,
    ...
    getCallee(body) {
        ...
        const calleeHelper = (item) => {
            ...
            if (item.type === 'VariableDeclaration') {
                try {
                    let calleeName = (_c = (_b = (_a = item.declarations[0]) === null || _a === void 0 ? void 0 : _a.init) === null || _b === void 0 ? void 0 : _b.callee) === null || _c === void 0 ? void 0 : _c.name;
                ...
                try {
                    const calleeName = (_e = (_d = item.expression) === null || _d === void 0 ? void 0 : _d.callee) === null || _e === void 0 ? void 0 : _e.name;
        ...
        if (bodyCallee.length === 1) {
            const calleeArr = (_c = (_b = (_a = bodyCallee[0].declarations[0]) === null || _a === void 0 ? void 0 : _a.init) === null || _b === void 0 ? void 0 : _b.body) === null || _c === void 0 ? void 0 : _c.body;
            if (calleeArr === undefined)
                return false;
            let checkTrue = false;
            ...
            for (let i = 0; i < bodyCallee.length; i++) {
                try {
                    if ((_f = (_e = (_d = bodyCallee[i].declarations[0]) === null || _d === void 0 ? void 0 : _d.init) === null || _e === void 0 ? void 0 : _e.body) === null || _f === void 0 ? void 0 : _f.body) {
